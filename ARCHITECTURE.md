// Modified by konlyzx (2026) - Updated project name from Stage to Better Flow; removed Prisma/PostgreSQL references; updated environment variables; added R2 storage and Chrome extension integration
// Base project structure under Apache License 2.0 (Copyright 2025 Kartik Labhshetwar)

# Better Flow Architecture Documentation

...
export const metadata: Metadata = {
  ...
  description: "Better Flow is a free screenshot editor and mockup maker online. Add gradient backgrounds, Safari/Chrome browser frames, shadows, 3D effects, and animations to your screenshots. Export as PNG, JPG, WebP, MP4, or GIF. No signup, no watermarks, unlimited exports. Free alternative to Pika Style and Shots.so.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Transform screenshots into professional graphics instantly. 100+ backgrounds, browser mockups, animations, 3D effects, video export. Free, no signup, no watermarks.",
    images: [
      {
  ...
  twitter: {
    ...
    description: "Transform screenshots into professional graphics instantly. Browser mockups, backgrounds, animations, 3D effects, video export. Free, no signup.",

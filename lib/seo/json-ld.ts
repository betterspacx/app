...
export function getOrganizationSchema() {
  return {
    ...
    sameAs: ['https://github.com/KartikLabhshetwar/screenshot-studio', 'https://x.com/konlyzx_'],
    description:
...
export function getRootJsonLd() {
  return {
    ...
    '@graph': [getOrganizationSchema(), getWebSiteSchema(), getSoftwareApplicationSchema()],
  };
}

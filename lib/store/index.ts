...
export const useImageStore = create<ImageState>()(
  temporal((set, get) => ({
    ...
    setImage: (file: File) => {
      ...
      // Reset effects when uploading a new image, but preserve background
      set({
        ...
        borderRadius: 10,
        backgroundBorderRadius: 10,
        // Background is preserved - NOT reset
        // Reset shadow
        imageShadow: {
          enabled: true,
          blur: 15,
    ...
    clearImage: () => {
      ...
      // Clear image and reset effects, but preserve background
      set({
        uploadedImageUrl: null,
        imageName: null,
        slides: [],
    ...
    addAnimationClip: (presetId, startTime) => {
      ...
      const colors = ['#c9ff2e', '#10B981', '#22c55e', '#84cc16', '#2b6fff'];

// Modified by konlyzx (2026) - Enhanced shadow preview aesthetics with darker refined look
...
function ShadowPreview({ shadow, selected }: { shadow: string; selected: boolean }) {
  return (
    ...
    >
      <div
        className="absolute bg-gradient-to-br from-white to-gray-100 rounded-[10px]"
        style={{
          top: '26%',
          left: '26%',
          width: '95%',

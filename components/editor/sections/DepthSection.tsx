// Modified by konlyzx (2026) - Changed primary green colors to brand blue
                  ...
                  >
                    ...
                    <div className="flex items-center gap-0.5 shrink-0">
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-md text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors opacity-0 group-hover:opacity-100 cursor-pointer"
                        title="Remove layer"
                      >
                  ...
                  {isSelected && isImageOverlay && (
                    <div className="flex items-center gap-1 px-2.5 pb-2 pt-0.5">
                      <button
                        ...
                        className="flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-medium text-muted-foreground hover:text-foreground hover:bg-accent transition-colors border border-border/30 cursor-pointer"
                        title="Move forward"
                      >
                      ...
                      <button
                        ...
                        className={cn(
                          'flex items-center gap-1 px-2 py-1 rounded-md text-[10px] font-medium transition-colors border cursor-pointer',
                          layer.layerPosition === 'back'
                            ? 'text-[#c9d4ff] border-[#c9d4ff]/20 bg-[#c9d4ff]/5 hover:bg-[#c9d4ff]/10'
            ...
            {activeAssets.map((assetPath) => {
              ...
              return (
                <button
                  ...
                  className="aspect-square rounded-xl border border-border/30 bg-muted/30 hover:bg-accent hover:border-border/60 transition-all duration-150 overflow-hidden p-2.5 group cursor-pointer"
                  title="Click to add"
                >
                  <img
                    src={url}
    ...
    <div className="space-y-3">
      <div className="space-y-2">
        ...
        <div className="flex gap-1.5">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1 py-1.5 rounded-lg bg-muted/50 border border-border/30 text-xs text-muted-foreground hover:text-foreground hover:bg-accent transition-colors cursor-pointer"
          >
      ...
      <div className="flex gap-1.5">
        <button
          ...
          className={cn(
            'flex-1 py-2 rounded-lg text-xs font-medium border transition-colors cursor-pointer',
            overlay.flipX

          ...
          {TOOLS.map((tool) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex flex-col items-center justify-center gap-1 py-2.5 rounded-xl text-[11px] font-medium transition-all duration-150 cursor-pointer',
                  isActive
              ...
              <div className="flex items-center gap-1.5 flex-wrap">
                {COLORS.map(({ value, name }) => (
                  <button
                    ...
                    title={name}
                    className={cn(
                      'w-7 h-7 rounded-full transition-all duration-150 shrink-0 cursor-pointer',
                      currentColor === value
            ...
            {blurRegions.map((region, index) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-1 text-muted-foreground hover:text-destructive transition-colors shrink-0 rounded hover:bg-destructive/10 cursor-pointer"
                  title="Remove"
                >

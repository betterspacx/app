    ...
    <div className="space-y-6">
      <Tabs defaultValue="style" className="w-full">
        <TabsList className="w-full grid grid-cols-3 rounded-none bg-transparent h-12 p-1.5 gap-1.5">
          <TabsTrigger
            value="style"
            className="data-[state=active]:bg-background rounded-md border-0 data-[state=active]:border-0 transition-all duration-200 text-xs"
          >
            Style
          </TabsTrigger>
          <TabsTrigger
        ...
        <TabsContent value="style" className="mt-4 space-y-6">
          ...
          <div className="space-y-3">
            ...
            />
            <p className="text-xs text-muted-foreground">Adjust the size of the image (10% - 200%)</p>
          </div>
        ...
        <TabsContent value="ratio" className="mt-4 space-y-6">
          <div className="space-y-3">
            <h4 className="text-xs font-semibold text-foreground uppercase tracking-wide">Canvas Size</h4>
            <p className="text-xs text-muted-foreground">Select aspect ratio for different platforms</p>
            <AspectRatioPicker />
          </div>
        </TabsContent>

        <TabsContent value="transforms" className="mt-4 space-y-6">
          <div className="text-sm text-muted-foreground text-center py-8">Transform controls coming soon</div>
        </TabsContent>
      </Tabs>
    </div>
  );

  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <svg width={smIco} height={smIco} viewBox="0 0 14 14" fill="none" style={{ flexShrink: 0, opacity: 0.45 }}>
            <path
              d="M12 7a5 5 0 11-1.5-3.5M12 2v2.5H9.5"
              stroke={iconColor}
              strokeWidth="1.4"
              strokeLinecap="round"
      ...
      >
        ...
        <svg width={ico} height={ico} viewBox="0 0 16 16" fill="none" style={{ opacity: 0.45 }}>
          <path
            d="M4.5 9.5v3.5a1 1 0 001 1h5a1 1 0 001-1v-3.5"
            stroke={iconColor}
            strokeWidth="1.4"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M8 2v7.5M8 2L5.5 4.5M8 2l2.5 2.5"
            stroke={iconColor}
            strokeWidth="1.4"
            strokeLinecap="round"
            strokeLinejoin="round"
        ...
        <svg width={ico} height={ico} viewBox="0 0 16 16" fill="none" style={{ opacity: 0.45 }}>
          ...
          <path
            d="M5.5 4V3a1.5 1.5 0 011.5-1.5h6A1.5 1.5 0 0114.5 3v6a1.5 1.5 0 01-1.5 1.5h-1"
            stroke={iconColor}
            strokeWidth="1.4"
          />
        </svg>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            display: 'flex',
            alignItems: 'center',
            padding: `0 ${Math.max(5, pad - 1)}px`,
            gap: `${gap}px`,
            minWidth: `${Math.round(windowHeader * 2)}px`,
            maxWidth: `${Math.round(windowHeader * 4.5)}px`,
          }}
        >
          <span
            style={{
          ...
          <svg
            width={Math.max(6, Math.round(ico * 0.85))}
            height={Math.max(6, Math.round(ico * 0.85))}
            viewBox="0 0 14 14"
            fill="none"
        ...
        <svg
          ...
          style={{
            marginLeft: `${gap}px`,
            alignSelf: 'flex-end',
            marginBottom: `${Math.max(1, Math.round((tabRiseH - ico) / 2))}px`,
            opacity: 0.5,
            flexShrink: 0,
          }}
        >
      ...
      >
        ...
        <svg width={ico} height={ico} viewBox="0 0 18 18" fill="none" style={{ flexShrink: 0, opacity: 0.6 }}>
          <path
            d="M14.5 9a5.5 5.5 0 11-1.7-4M14.5 3.5V6.5H11.5"
            stroke={iconColor}
            strokeWidth="1.6"
            strokeLinecap="round"
            strokeLinejoin="round"
